...
#     models = [
#     #"llama-3.1-405b-reasoning", #might not be available for a call to the api.Try others if this raises an error"
...
#     def get_response(self, message, model=models[0],temperature=0):
#         try:
...
#     def get_response_batch(self, message, model=models[0], temperature=0):
#         try:
#             response = self.groq_client.chat.completions.create(
#                 model = model,
#                 messages = [
